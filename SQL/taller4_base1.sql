...
-----------------------------------------------------
--Se busca el estudiante y se retorna los cursos

select A.nombres, A.apellidos, curso.nombre, curso.curso_cod
from curso join (select *
from estCursos join estudiante
on estudiante.id = estCursos.estID) as A
on curso.curso_cod = A.curso_cod
where A.nombres = 'Ana'; -- Se busca el nombre Ej: Ana